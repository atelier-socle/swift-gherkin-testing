# Contributing to swift-gherkin-testing
...
- Test files go in `Tests/GherkinTestingTests/` (unit/integration) or `Tests/GherkinTestingMacroTests/` (macro expansion)
- Use `#expect` and `#require` for assertions

## Pull Request Guidelines

- **Clear title** describing the change (e.g., "Add support for custom parameter types")
...
- Minimal code sample or `.feature` file if applicable

## Project Structure

- `Sources/GherkinTesting/` — main library (parser, compiler, execution, reporters)
- `Sources/GherkinTestingMacros/` — compiler plugin (macro implementations)
- `Tests/GherkinTestingTests/` — unit and integration tests
- `Tests/GherkinTestingMacroTests/` — macro expansion tests
- `Tests/GherkinTestingDemoTests/` — end-to-end demo tests
